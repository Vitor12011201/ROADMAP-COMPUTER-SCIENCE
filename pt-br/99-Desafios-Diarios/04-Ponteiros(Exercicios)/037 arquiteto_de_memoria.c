...
int main()
{
    ...
    // Esse vai retornar 8 Bytes tambem mas ele retorna o endereço da variavel Real e não o valor de um double
    printf("O tamanho de *ptr e igual a %zu Bytes\n", sizeof(*ptr));
    // Esse tambem vai retornar 8 Bytes pois devolve o valor que o programa separa para um double
